...
UPDATE_URL = "https://api.github.com/repos/ironsource-mobile/spotcli/releases/latest"
UPDATE_COMMAND = 'bash -c "$(curl -fsSL https://raw.githubusercontent.com/ironsource-mobile/spotcli/main/install.sh)"'
